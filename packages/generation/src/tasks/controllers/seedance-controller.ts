...
import type { TaskController, DownloadResultInput, TaskControllerStartInput } from '../task-controller-registry';
...
async function submitSeedanceTask(input: TaskControllerStartInput): Promise<string> {
